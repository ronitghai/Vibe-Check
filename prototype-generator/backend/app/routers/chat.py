...
def chat(req: ChatRequest) -> ChatResponse:
    reply, game_ready, game_id, game_type = orchestrator.run_turn(req.session_id, req.message)
    return ChatResponse(reply=reply, game_ready=game_ready, game_id=game_id, game_type=game_type)
